...
<br/>
<div align="center">
    <form action="freebbsupdateaf.do" method="post">
        ...
        <button type="submit" id="freeBbsUpdateSubmit" class="btn btn-primary">수정완료</button>
       	<button type="button" class="btn btn-primary" onclick="returnlist()">글목록으로</button>
    </form>
</div>

<script type="text/javascript">
	$('#freeBbsUpdateSubmit').click(function(){
		let title = $('#title').val();
